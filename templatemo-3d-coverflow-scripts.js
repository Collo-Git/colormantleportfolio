...
// JavaScript Document
        ...
        const imageData = [
            {
                title: "Church Flyers",
                description: "Bold and vibrant flyers for your church events"
            },
            {
                title: "School Flyers",
                description: "Elegant flyers to promote your school events and activities"
            },
            {
                title: "Outdoor Events Flyers",
                description: "Eye-catching flyer designs for weddings, birthdays, concerts, corporate events, and community gatherings"
            },
            {
                title: "Logo Design & Brand Identity",
                description: "Professional logo designs that define brands and communicate identity"
            },
            {
                title: "Videography",
                description: "Professional videography for events, churches, outdoor activities, and brand stories."
            },
            {
                title: "Photography",
                description: "Creative photography covering events, portraits, products, and outdoor shoots."
            },
            {
                title: "Photo & Video Editing",
                description: "Polished photo and video edits that enhance visuals and tell your story with impact."
            }
        ];
    ...
    item.addEventListener('click', (e) => {
        ...
        // Only intercept valid section IDs
